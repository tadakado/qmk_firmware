...
#define PRODUCT         mucon
#define DESCRIPTION     A music controller with 5 buttons
 ...
 *
*/
#define MATRIX_ROW_PINS {6} // Dummy
#define MATRIX_COL_PINS {16,15,18,7,9}
#define MATRIX_LAYOUT {1,2,3,4,5,255}

#define KEYMAP_PRIOR_LOCALE 0
#define KEYMAP_ASCII 0
#define CONFIG_RESERVED { 0, 20, 0, 0, 0, 0, 0, 0 }
