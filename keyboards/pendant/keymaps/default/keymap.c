...
// pointing device (Cirque Trackpad and CH559 uart)
...
extern const bmp_matrix_func_t matrix_func_col2row_io_expander;

const bmp_matrix_func_t *get_matrix_func_user(void) {
    return &matrix_func_col2row_io_expander;
}
